...
class TestCRUD(unittest.TestCase):
    ...
    def owner_owns_apartment(self):
        ...
        self.assertEqual(owner_drops_apartment(1, 3), ReturnValue.OK)
        self.assertEqual(owner_drops_apartment(1, 3), ReturnValue.NOT_EXISTS)
        self.assertEqual(owner_drops_apartment(0, 3), ReturnValue.BAD_PARAMS)
